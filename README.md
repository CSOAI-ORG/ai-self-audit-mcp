[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/ai-self-audit-mcp.html)
...
- "Use `self_audit` to …"
- "Use `audit_conversation` to …"
- "Use `get_certificate` to …"
